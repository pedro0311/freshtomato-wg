...
/* wireguard */
	...
	{ "wg_iface1_endpoint",		V_TEXT(0, 64)		},
	{ "wg_iface1_port",			V_PORT				},
	{ "wg_iface1_ip",			V_TEXT(0, 32)		},
	{ "wg_iface1_fwmark",		V_TEXT(0, 8)		},
	{ "wg_iface1_mtu",			V_RANGE(0, 1500)	},
	{ "wg_iface1_preup",		V_NONE				},
	{ "wg_iface1_postup",		V_NONE				},
	{ "wg_iface1_predown",		V_NONE				},
	{ "wg_iface1_postdown",		V_NONE				},
	{ "wg_iface1_aip",			V_TEXT(0, 128)		},
	{ "wg_iface1_dns",			V_TEXT(0, 128)		},
	{ "wg_iface1_ka",			V_RANGE(0, 128)		},
	{ "wg_iface1_lan",			V_01				},
	{ "wg_iface1_lan0",			V_01				},
	{ "wg_iface1_lan1",			V_01				},
	{ "wg_iface1_lan2",			V_01				},
	{ "wg_iface1_lan3",			V_01				},
	{ "wg_iface1_rgw",			V_01				},
	{ "wg_iface1_peers",		V_NONE				},
	{ "wg_iface2_eas",			V_01				},
	{ "wg_iface2_file",			V_TEXT(0, 64)		},
	{ "wg_iface2_key",			V_TEXT(0, 44)		},
	{ "wg_iface2_endpoint",		V_TEXT(0, 64)		},
	{ "wg_iface2_port",			V_PORT				},
	{ "wg_iface2_ip",			V_TEXT(0, 32)		},
	{ "wg_iface2_fwmark",		V_TEXT(0, 8)		},
	{ "wg_iface2_mtu",			V_RANGE(0, 1500)	},
	{ "wg_iface2_preup",		V_NONE				},
	{ "wg_iface2_postup",		V_NONE				},
	{ "wg_iface2_predown",		V_NONE				},
	{ "wg_iface2_postdown",		V_NONE				},
	{ "wg_iface2_aip",			V_TEXT(0, 128)		},
	{ "wg_iface2_dns",			V_TEXT(0, 128)		},
	{ "wg_iface2_ka",			V_RANGE(0, 128)		},
	{ "wg_iface2_lan",			V_01				},
	{ "wg_iface2_lan0",			V_01				},
	{ "wg_iface2_lan1",			V_01				},
	{ "wg_iface2_lan2",			V_01				},
	{ "wg_iface2_lan3",			V_01				},
	{ "wg_iface2_rgw",			V_01				},
	{ "wg_iface2_peers",		V_NONE				},
	{ "wg_iface3_eas",			V_01				},
	{ "wg_iface3_file",			V_TEXT(0, 64)		},
	{ "wg_iface3_key",			V_TEXT(0, 44)		},
	{ "wg_iface3_endpoint",		V_TEXT(0, 64)		},
	{ "wg_iface3_port",			V_PORT				},
	{ "wg_iface3_ip",			V_TEXT(0, 32)		},
	{ "wg_iface3_fwmark",		V_TEXT(0, 8)		},
	{ "wg_iface3_mtu",			V_RANGE(0, 1500)	},
	{ "wg_iface3_preup",		V_NONE				},
	{ "wg_iface3_postup",		V_NONE				},
	{ "wg_iface3_predown",		V_NONE				},
	{ "wg_iface3_postdown",		V_NONE				},
	{ "wg_iface3_aip",			V_TEXT(0, 128)		},
	{ "wg_iface3_dns",			V_TEXT(0, 128)		},
	{ "wg_iface3_ka",			V_RANGE(0, 128)		},
	{ "wg_iface3_lan",			V_01				},
	{ "wg_iface3_lan0",			V_01				},
	{ "wg_iface3_lan1",			V_01				},
	{ "wg_iface3_lan2",			V_01				},
