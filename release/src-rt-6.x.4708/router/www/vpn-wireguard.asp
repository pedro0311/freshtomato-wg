	...
	<script>
		...
		for (i = 0; i < tabs.length; ++i) {
			...
			createFieldTable('', [
				...
				{ title: 'Interface IP', name: 'wg_'+t+'_ip', type: 'text', maxlen: 32, size: 17, value: eval('nvram.wg_'+t+'_ip') },
			...
			createFieldTable('', [
				...
				{ title: 'Interface IP', name: 'f_wg_'+t+'_peer_ip', type: 'text', maxlen: 64, size: 64},
