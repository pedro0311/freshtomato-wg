...
extern int wg_iface_script(int unit, char *script_name);
extern int wg_iface_pre_up(int unit);
extern int wg_iface_post_up(int unit);
extern int wg_iface_pre_down(int unit);
extern int wg_iface_post_down(int unit);
