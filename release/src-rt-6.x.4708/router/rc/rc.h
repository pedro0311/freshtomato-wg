...
extern int wg_add_peer(char *iface, char *peer_pubkey, char *allowed_ips, char *presharedkey, char *keepalive);
extern int wg_add_peer_privkey(char *iface, char *privkey, char *allowed_ips, char *presharedkey, char *keepalive);
